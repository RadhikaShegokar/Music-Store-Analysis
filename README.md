...
Note: If you are using PostgreSQL then restore the <a href="https://github.com/RadhikaShegokar/Music-Store-Analysis/blob/main/music_store_db_backup">backup</a> file of the database and save yourself some time.
